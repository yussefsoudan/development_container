-- credit: https://github.com/samhvw8/mvim/blob/master/lua/core/coc.lua
...
vim.g.coc_npm_path = '/usr/bin/npm'
...
local mappings = {
        ...
        {'gx', 'CocCommand clangd.switchSourceHeader<CR>', { noremap = false, silent = true }},
